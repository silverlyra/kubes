...
export interface JSONSchemaProps {
   ...
   */
  default?: JSON
  definitions?: {[name: string]: JSONSchemaProps}
  dependencies?: {[name: string]: JSONSchemaPropsOrStringArray}
  description?: string
  enum?: Array<JSON>
  example?: JSON
  ...
  pattern?: string
  patternProperties?: {[name: string]: JSONSchemaProps}
  properties?: {[name: string]: JSONSchemaProps}
